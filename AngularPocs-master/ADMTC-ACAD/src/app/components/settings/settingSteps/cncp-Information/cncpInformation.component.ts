...
@Component({
    selector: 'app-cncpInformation',
    templateUrl: './cncpInformation.component.html'

})
export class CNCPInformation implements OnInit {
    form: FormGroup;
    countryList: any[] = [
    { id: '1', countryName: 'France' },
        ...
        { id: '88', countryName: 'Åland Islands' },
    ...
    constructor() {
        this.form = new FormGroup({
            ...
            GeneralMail: new FormControl('', Validators.required)
        });
    }
