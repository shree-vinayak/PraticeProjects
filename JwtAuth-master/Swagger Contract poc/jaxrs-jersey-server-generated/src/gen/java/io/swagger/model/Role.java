 ...
 * Role
 */
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2019-06-01T10:04:14.100Z[GMT]")public class Role   {
  @JsonProperty("idRole")
   ...
   **/
  @JsonProperty("idRole")
  @Schema(example = "2006", description = "")
   ...
   **/
  @JsonProperty("create")
  @Schema(example = "3252", description = "")
   ...
   **/
  @JsonProperty("read")
  @Schema(example = "235", description = "")
   ...
   **/
  @JsonProperty("update")
  @Schema(example = "234", description = "")
   ...
   **/
  @JsonProperty("delete")
  @Schema(example = "325", description = "")
   ...
   **/
  @JsonProperty("execute")
  @Schema(example = "452", description = "")
   ...
   **/
  @JsonProperty("name")
  @Schema(example = "Aditya", description = "")
   ...
   **/
  @JsonProperty("nameShort")
  @Schema(example = "adu", description = "")
