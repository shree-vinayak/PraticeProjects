 ...
 * Circle
 */
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2019-06-01T10:04:14.100Z[GMT]")public class Circle   {
   ...
   **/
  @JsonProperty("idCircle")
  @Schema(example = "2003", description = "")
   ...
   **/
  @JsonProperty("name")
  @Schema(example = "Jabalupur Circle", description = "")
