...
public class SsDevice   {
  ...
  **/
  ...
  public SsDevice number(Long number) {
    this.number = number;
    return this;
  }
  ...
  **/
  ...
  public SsDevice substationDeviceMapping(List<SubstationDeviceMapping> substationDeviceMapping) {
    this.substationDeviceMapping = substationDeviceMapping;
    return this;
  }

  public SsDevice addSubstationDeviceMappingItem(SubstationDeviceMapping substationDeviceMappingItem) {
  ...
  **/
  ...
  public SsDevice instalationDate(OffsetDateTime instalationDate) {
  ...
  **/
  ...
  public SsDevice simNumber(Long simNumber) {
  ...
  **/
  ...
  public SsDevice mobileNumber(Long mobileNumber) {
  ...
  **/
  ...
  public SsDevice telecomOperator(String telecomOperator) {
  ...
  **/
  ...
  public SsDevice startDate(LocalDate startDate) {
  ...
  **/
  ...
  public SsDevice endDate(LocalDate endDate) {
  ...
  **/
  ...
  public SsDevice isActive(Boolean isActive) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SsDevice ssDevice = (SsDevice) o;
    return Objects.equals(this.id, ssDevice.id) &&
        Objects.equals(this.number, ssDevice.number) &&
        Objects.equals(this.substationDeviceMapping, ssDevice.substationDeviceMapping) &&
        Objects.equals(this.instalationDate, ssDevice.instalationDate) &&
        Objects.equals(this.simNumber, ssDevice.simNumber) &&
        Objects.equals(this.mobileNumber, ssDevice.mobileNumber) &&
        Objects.equals(this.telecomOperator, ssDevice.telecomOperator) &&
        Objects.equals(this.startDate, ssDevice.startDate) &&
        Objects.equals(this.endDate, ssDevice.endDate) &&
        Objects.equals(this.isActive, ssDevice.isActive);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, number, substationDeviceMapping, instalationDate, simNumber, mobileNumber, telecomOperator, startDate, endDate, isActive);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SsDevice {\n");
