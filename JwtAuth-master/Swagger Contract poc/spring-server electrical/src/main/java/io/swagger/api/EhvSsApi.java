...
public interface EhvSsApi {
    ...
    @ApiOperation(value = "returns a boolean value", nickname = "disableEhvSs", notes = "Here it will set the isActive field false", response = Boolean.class, responseContainer = "List", authorizations = {
        @Authorization(value = "BearerAuth")    }, tags={ "electrical", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<List<Boolean>> disableEhvSs(@Min(0)@ApiParam(value = "id of the EhvSs to set isActive false",required=true, allowableValues = "") @PathVariable("id") Integer id);
