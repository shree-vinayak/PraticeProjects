...
public class EhvSsApiController implements EhvSsApi {
    ...
    public ResponseEntity<List<Boolean>> disableEhvSs(@Min(0)@ApiParam(value = "id of the EhvSs to set isActive false",required=true, allowableValues = "") @PathVariable("id") Integer id) {
        String accept = request.getHeader("Accept");
