 ...
 * Substation
 */
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2019-06-03T08:58:29.494Z[GMT]")public class Substation   {
  @JsonProperty("id")
   ...
   **/
  @JsonProperty("name")
  @Schema(example = "Satya sai substation", description = "")
  ...
  public Substation startDate(Date startDate) {
  ...
  public Substation endDate(Date endDate) {
