 ...
 * PoleDevice
 */
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2019-06-03T08:58:29.494Z[GMT]")public class PoleDevice   {
  @JsonProperty("id")
  ...
  public PoleDevice instalationDate(Date instalationDate) {
  ...
  public PoleDevice startDate(Date startDate) {
  ...
  public PoleDevice endDate(Date endDate) {
