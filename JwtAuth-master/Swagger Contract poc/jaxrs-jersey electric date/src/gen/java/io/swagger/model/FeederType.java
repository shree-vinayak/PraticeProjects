 ...
 * FeederType
 */
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2019-06-03T08:58:29.494Z[GMT]")public class FeederType   {
  @JsonProperty("id")
   ...
   **/
  @JsonProperty("type")
  @Schema(example = "AgreeCulture Feeder", description = "")
